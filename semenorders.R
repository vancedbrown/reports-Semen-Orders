...
aarmas<-orders1 %>% filter(Specialist=="ARMAS TORRES, ANDRES A")
...
rgarcia<-orders1 %>% filter(Specialist=="GARCIA RIVERA, RIGOBERTO D")
...
rosorto<-orders1 %>% filter(Specialist=="OSORTO PERDOMO, ROGER A")
